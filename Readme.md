...
dan untuk kaum mendang-mending yang khawatir kalau billingnya ke charge hanya untuk belajar/inite awal, tenang saja, di terraform ada provider docker, jadi kita bisa langsung praktik di local machine kita.

ada beberapa key yang bisa di higligh dari pembelajaran ini:
1. Core Workflow (init, plan, apply, destroy).
2. Configuration Flow (Root → Module → Resources).
